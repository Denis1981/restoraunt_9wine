        ...
        <div className="row">
            {
                articles.map((articles, i) => (
                    <div className="col-xxl-4" key={articles.id}>
                        <div className="card">
                            <img src={articles.photo} className="card-img-top z-depth-1" alt={articles.category} />
                              <div className="card-body z-depth-1">
                                  <Link key={articles.id} to={`/articles/${articles.id}`}>
                                      <h2 className="card-title" dangerouslySetInnerHTML={{ __html: articles.title.slice(0,50) }}/>
